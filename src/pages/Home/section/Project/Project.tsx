  ...
  const projects = [
    {
      ...
      projectDesc: `This web application renders a beautiful model of our solar system and is built using React.js and Three.js`,
      projectLink: 'https://illsmithda.github.io/solar_system/',
      shortLink: 'illsmithda.github.io/solar_system',
